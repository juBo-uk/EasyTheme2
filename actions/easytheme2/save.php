...
$et2color1 = elgg_get_plugin_setting('et2color1','easytheme2');
$et2color2 =  elgg_get_plugin_setting('et2color2','easytheme2');
$et2_bkimg = 'url(\'<?php echo elgg_get_site_url(); ?>mod/easytheme2/graphics/bkgr.jpg\')';
$et2_headimg = 'url(\'<?php echo elgg_get_site_url(); ?>mod/easytheme2/graphics/headimg.jpg\')';
$et2footh =  elgg_get_plugin_setting('et2footh','easytheme2');
$et2footbk =  elgg_get_plugin_setting('et2footbk','easytheme2');
$et2footlink = elgg_get_plugin_setting('et2footlink','easytheme2');
$et2foothov = elgg_get_plugin_setting('et2foothov','easytheme2');
$et2foottext = elgg_get_plugin_setting('et2foottext','easytheme2');
$et2search = elgg_get_plugin_setting('et2search','easytheme2');
$et2intro = elgg_get_plugin_setting('et2intro','easytheme2');
$et2menu = elgg_get_plugin_setting('et2menu','easytheme2');
$et2menua = elgg_get_plugin_setting('et2menua','easytheme2');
$et2menu1 = elgg_get_plugin_setting('et2menu1','easytheme2');
...
//this bit writes the file...
$file2 = elgg_get_data_path() . "easytheme2/intro.php";
$fileHandle = fopen($file2, 'w') or die("Error opening file"); 
$data = $et2intro;
fwrite($fileHandle, $data); 
fclose($fileHandle);
elgg_unset_plugin_setting ('et2intro','easytheme2');
}
...
//this bit writes the file...
$file3 = elgg_get_data_path() . "easytheme2/textleft.php";
$fileHandle = fopen($file3, 'w') or die("Error opening file"); 
$data = $et2textleft;
fwrite($fileHandle, $data); 
fclose($fileHandle);
elgg_unset_plugin_setting ('et2textleft','easytheme2');
}
...
//this bit writes the file...
$file4 = elgg_get_data_path() . "easytheme2/textright.php";
$fileHandle = fopen($file4, 'w') or die("Error opening file"); 
$data = $et2textright;
fwrite($fileHandle, $data); 
fclose($fileHandle);
elgg_unset_plugin_setting ('et2textright','easytheme2');
}
